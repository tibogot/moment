    ...
    <GridSection className="py-[14svh]">
      <div className="col-start-2 col-end-5 md:col-end-8">
        <TextReveal blockColor={SKY} stagger={0.12}>
          <h2 className="font-owners-narrow-bold text-[11vw] leading-[0.95] tracking-[-0.005em] text-black uppercase md:text-[6vw]">
      ...
      <div className="col-start-2 col-end-5 mt-[6svh] md:col-start-5 md:col-end-8 md:mt-[10svh]">
