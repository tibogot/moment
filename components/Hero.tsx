  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="col-start-2 col-end-5 row-start-4 row-end-5 self-end pb-4 pl-(--grid-gutter) text-left md:col-end-7 md:row-start-3 md:row-end-5 md:pb-[3.3svh]">
          <TextReveal animateOnScroll={false} blockColor={CREAM} delay={0.25}>
            <h1
              className="font-owners-narrow-bold leading-[0.9] tracking-[-0.005em] uppercase"
        ...
        <div className="col-start-3 col-end-5 row-start-3 row-end-4 self-end pr-(--grid-gutter) pb-4 text-right md:col-start-7 md:col-end-9 md:row-start-4 md:row-end-5 md:pb-[4.3svh]">
          <TextReveal
          ...
          >
            <p
              className="font-archivo-light leading-[1.43]"
